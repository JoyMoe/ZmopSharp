...
{
    /// <summary>
    /// ZMOP API: zhima.credit.ep.operationalreport.get
    /// </summary>
    public class ZhimaCreditEpOperationalreportGetRequest : IZmopRequest<ZhimaCreditEpOperationalreportGetResponse>
    {
        /// <summary>
        /// 用户授权后的openId
        /// </summary>
