...
{
    /// <summary>
    /// ZMOP API: zhima.credit.ep.lawsuit.record.get
    /// </summary>
    public class ZhimaCreditEpLawsuitRecordGetRequest : IZmopRequest<ZhimaCreditEpLawsuitRecordGetResponse>
    {
        /// <summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("org_no", this.OrgNo);
