...
{
    /// <summary>
    /// ZMOP API: zhima.customer.certification.certify
    /// </summary>
    public class ZhimaCustomerCertificationCertifyRequest : IZmopRequest<ZhimaCustomerCertificationCertifyResponse>
    {
        /// <summary>
