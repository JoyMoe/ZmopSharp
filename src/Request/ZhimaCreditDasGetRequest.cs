...
{
    /// <summary>
    /// ZMOP API: zhima.credit.das.get
    /// </summary>
    public class ZhimaCreditDasGetRequest : IZmopRequest<ZhimaCreditDasGetResponse>
    {
        /// <summary>
        ...
        /// </summary>
        public string ExtParas { get; set; }
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("ext_paras", this.ExtParas);
