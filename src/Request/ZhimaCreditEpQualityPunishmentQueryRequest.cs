...
{
    /// <summary>
    /// ZMOP API: zhima.credit.ep.quality.punishment.query
    /// </summary>
    public class ZhimaCreditEpQualityPunishmentQueryRequest : IZmopRequest<ZhimaCreditEpQualityPunishmentQueryResponse>
    {
        /// <summary>
