...
{
    /// <summary>
    /// ZMOP API: zhima.merchant.scene.creditpay.signriskeval.query
    /// </summary>
    public class ZhimaMerchantSceneCreditpaySignriskevalQueryRequest : IZmopRequest<ZhimaMerchantSceneCreditpaySignriskevalQueryResponse>
    {
        /// <summary>
        /// 二级商户应用id
        /// </summary>
