...
{
    /// <summary>
    /// ZMOP API: zhima.credit.antifraud.integration.query
    /// </summary>
    public class ZhimaCreditAntifraudIntegrationQueryRequest : IZmopRequest<ZhimaCreditAntifraudIntegrationQueryResponse>
    {
        /// <summary>
