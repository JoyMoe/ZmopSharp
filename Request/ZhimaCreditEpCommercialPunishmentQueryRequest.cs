...
{
    /// <summary>
    /// ZMOP API: zhima.credit.ep.commercial.punishment.query
    /// </summary>
    public class ZhimaCreditEpCommercialPunishmentQueryRequest : IZmopRequest<ZhimaCreditEpCommercialPunishmentQueryResponse>
    {
        /// <summary>
